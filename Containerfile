...
# ttf-symbola | opentabletdriver | colloid-catppuccin-gtk-theme-git | colloid-catppuccin-theme-git | paru |
...
# "A hero does what's right, even if it crushes them inside."
